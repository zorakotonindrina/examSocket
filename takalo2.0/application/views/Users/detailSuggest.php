...
<body>
   ...
   <div class="container" style="margin-left: 25%;" >
    <div class="row">
    <?php foreach($objet1->result_array() as $rows) {?>  
    <div class="col-lg-4">
        ...
        <h5 class="card-title"><?php echo $rows['nom']; ?></h5>
          ...
          <p class="card-text"><?php echo $nom1; ?> $</p>
      </div><!-- /.col-lg-4 -->
      <?php } ?>
      <?php foreach($objet2->result_array() as $rows) {?> 
      <div class="col-lg-4" style="margin-right: 100px;">
        <svg class="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#777"/><text x="50%" y="50%" fill="#777" dy=".3em">140x140</text></svg>
        <h5 class="card-title"><?php echo $rows['nom']; ?></h5>
          <p class="card-text"><?php echo $rows['description']; ?></p>
          <p class="card-text"><?php echo $rows['prixestimatif']; ?> $</p>
          <p class="card-text"><?php echo $nom2; ?> $</p>
      </div><!-- /.col-lg-4 -->
      <?php } ?>
      
        <p style="margin-left: 20%;"><a class="btn btn-secondary" href="<?php echo base_url('PropositionController/accepter?idp='.$idp); ?>">Accepter&raquo;</a></p>
        <p style="margin-left: 25%;"><a class="btn btn-secondary" href="<?php echo base_url('PropositionController/refuser?idp='.$idp); ?>">Refuser &raquo;</a></p>
