...
<body>
    ...
    <div class="card" style="width: 18rem;">
        ...
        <div class="card-body">
          <h5 class="card-title"><?php echo $resultat[$i]['nom']; ?></h5>
          <p class="card-text"><?php echo $resultat[$i]['description']; ?></p>
          <p class="card-text"><?php echo $resultat[$i]['prixestimatif']; ?> $</p>
